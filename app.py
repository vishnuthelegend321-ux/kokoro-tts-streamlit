...
```markdown:requirements.txt:requirements.txt
streamlit
kokoro-tts
```eof
...
```markdown:packages.txt:packages.txt
libsndfile1
```eof

After you have updated these three files in your GitHub repository, your app will start to redeploy on Streamlit Community Cloud. Please be patient, as this version will take a very long time for its first startup. If you see an error about memory, we will know that the free hosting is not sufficient for this powerful library.
